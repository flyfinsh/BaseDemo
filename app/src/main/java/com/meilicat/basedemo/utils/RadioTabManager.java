...
public class RadioTabManager implements OnCheckedChangeListener {
    ...
    public void updateDetailCount(String alCount, String wayCount) {
        int count = mRadioGroup.getChildCount();
        if(count > 0) {
            RadioButton alRadioBtn = (RadioButton) mRadioGroup.getChildAt(0);
            alRadioBtn.setText(alCount);
            RadioButton wayRadioBtn = (RadioButton) mRadioGroup.getChildAt(1);
            wayRadioBtn.setText(wayCount);
        }
    }
