...
import com.meilicat.basedemo.base.ClipPictureActivity;
...
public class BitmapPickUtils {
     ...
     * 切图
     */
    public static void startPhotoClip(BaseTitleActivity activity, String path, int requestCode) {
        /**
         *
    ...
    private static void alert(Activity activity) {
        Dialog dialog = new AlertDialog.Builder(activity).setTitle("提示").setMessage("您选择的不是有效的图片")
                .setPositiveButton(R.string.app_confirm_text, new DialogInterface.OnClickListener() {
                    @Override
