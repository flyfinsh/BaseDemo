...
public class FlowLayout extends ViewGroup {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        ...
        try {
            horizontalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_horizontalSpacing, 10);
            verticalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_verticalSpacing, 5);
