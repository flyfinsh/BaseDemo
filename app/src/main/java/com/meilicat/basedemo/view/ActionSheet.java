...
public class ActionSheet extends Fragment implements OnClickListener {
    ...
    private static final String ARG_OTHER_BUTTON_TEXT_COLOR = "other_button_text_color";
...
//        int color = getOtherButtonTextColor();
        if (titles != null) {
...
//                if (titles[i].equals("删除")) {
//                    bt.setTextColor(Color.parseColor("#f03700"));
//                } else {
...
//        bt.getPaint().setFakeBoldText(true);
    ...
    private Attributes readAttribute() {
        ...
        attrs.actionSheetTextSize = a.getDimension(R.styleable.ActionSheet_actionSheetTextSize,
    ...
    private int getOtherButtonTextColor() {
        return getArguments().getInt(ARG_OTHER_BUTTON_TEXT_COLOR);
    }
    ...
    public static class Builder {
        ...
        private ActionSheetListener mListener;
        private int btnTxtColor = Color.parseColor("#ff0099");
        ...
        public Builder setBtnTxtColor(int color) {
            btnTxtColor = color;
            return this;
        }
        ...
        public Bundle prepareArguments() {
            ...
            bundle.putInt(ARG_OTHER_BUTTON_TEXT_COLOR, btnTxtColor);
            return bundle;
        }
